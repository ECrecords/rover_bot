...
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { pwm_out_1 }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
...
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { jd_tri_io[7] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]             
