...
#define STEP_RESOLUTION_MASK 	0x00000007

#define DIR_FWD	0
#define DIR_BWD	1

//#define DIRECTION(DIR) 	0x000000(DIR)0
#define DIRECTION_MASK 	0x00000008

#define ENABLE	0
#define DISABLE 1

#define ENABLE_MASK 0x00000010

#define RESET_ON 0
#define RESET_OFF 1
#define RESET_MASK 0x00000020

#define SLEEP_ON 0
#define SLEEP_OFF 1
#define SLEEP_MASK 0x00000040
